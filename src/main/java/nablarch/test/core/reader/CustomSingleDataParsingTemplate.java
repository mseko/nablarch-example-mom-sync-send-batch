 ...
 */
abstract class CustomSingleDataParsingTemplate<RET> extends CustomTestDataParsingTemplate<RET> {
     ...
     */
    CustomSingleDataParsingTemplate(TestDataReader reader, List<TestDataInterpreter> interpreters, DataType targetType) {
