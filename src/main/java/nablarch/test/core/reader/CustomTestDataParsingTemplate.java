 ...
 * @author T.Kawasaki
 */
abstract class CustomTestDataParsingTemplate<RET> {
     ...
     */
    CustomTestDataParsingTemplate(TestDataReader reader, List<TestDataInterpreter> interpreters, DataType targetType) {
        this.reader = reader;
    ...
    public final void parse(String directory, String resource, String id, boolean useCache) {
        ...
        //キャッシュ使用有無の判定にフラグも併用する。
        if (!TEST_DATA_CACHE.containsKey(dataCacheKey) || !useCache) {
