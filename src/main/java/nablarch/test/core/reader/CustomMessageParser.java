...
public class CustomMessageParser extends CustomSingleDataParsingTemplate<MessagePool> {
     ...
     */
    public CustomMessageParser(TestDataReader reader, List<TestDataInterpreter> interpreters, DataType targetType) {
